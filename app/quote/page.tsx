...
const page = () => {
  ...
  return (
    <div className=' w-full min-h-screen bg-[#f9f9f9] relative  p-0'>
      <div className=' w-full h-screen   p-3 relative overflow-hidden'>
        <div className='shadow-[0_8px_4px_#00000014,0_2px_4px_#0000001a] w-full relative h-full grid grid-cols-6'>
          ...
          <div className='col-span-4 border-r overflow-y-auto h-screen bg-white border-dashed border-gray-400 scrollbar-none '>
            <div>
              <div className='p-4'>
                {/* Back Arrow */}
                <Link
